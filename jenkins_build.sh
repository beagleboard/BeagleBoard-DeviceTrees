...
dtc_git_build () {
	...
	echo "make clean"
	make clean
	echo "make CC=gcc CROSS_COMPILE= all"
...
echo "*********************************************"
echo "dtc: `~/git/dtc/dtc --version`"
DTC=~/git/dtc/dtc DTCVERSION=2.0.0 make clean
DTC=~/git/dtc/dtc DTCVERSION=2.0.0 make all || exit 1
echo "*********************************************"
